      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><!-- Link back to eng:ahmed &#10084; can't be removed.-->
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://www.instagram.com/aux1.0" target="_blank">eng:ahmed &#10084;</a>
  <!-- Link back to eng:ahmed  can't be removed. --></p>
          </div>
        </div>
      </div>
    </footer>
