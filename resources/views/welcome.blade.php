	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="ftco-nav">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item cta ml-1"><a href="{{route('login')}}" class="nav-link">Register</a></li>
			</ul>
		</div>
	</div>
</nav>
	...
	<div class="container">
			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					...
					<div class="block-23 mb-3">
						<ul>
							<li><span class="icon icon-map-marker"></span><span class="text">Exmple address</span></li>
		...
		<div class="row">
			<div class="col-md-12 text-center">
				...
				<p>
					{{-- This templet is made by Ahmed --}}
					Copyright &copy;<script>
						document.write(new Date().getFullYear());
					</script> All rights reserved Eng:ahmed
				</p>
			</div>
		</div>
	</div>
